                            ...
                            <div class="col-lg-6">
                                <form role="form"  action="{{route('citizens::insertInformation')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="2062-02-04" name="dob">
                                        <span class="text-danger">{{ $errors->first('dob') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label>Age</label>
                                        <input class="form-control" placeholder="Enter age of person" name="age">
                                    ...
                                    {{--<div class="form-group">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" value="">Bachelor
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
